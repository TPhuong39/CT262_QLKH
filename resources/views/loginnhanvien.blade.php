        ...
        <section class="py-12 bg-gray-100">
            <div class="container mx-auto px-4">
                ...
                <div class="flex justify-center">
                    <form action="{{route('staff.loginpost')}}" method="POST"
                        class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                        @csrf
                        <div class="form-group">
                            <label for="NV_Email" class="block text-sm font-medium text-gray-700">Email</label>
                            <input type="email"name="NV_Email" required placeholder="Nhập email nhân viên"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500">
                        </div>
                        <div class="form-group">
                            <label for="NV_MatKhau" class="block text-sm font-medium text-gray-700">Mật Khẩu</label>
                            <input type="password"name="NV_MatKhau" required
