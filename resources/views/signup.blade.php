        ...
        <section class="py-12 bg-gray-100">
            <div class="container mx-auto px-4">
                ...
                <div class="flex justify-center">
                    <form action="{{route('customer.signuppost')}}" method="POST"
                        class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                        @csrf
                        <div class="form-group">
                            <label for="KH_HoTen" class="block text-sm font-medium text-gray-700">Họ Tên</label>
                            <input type="text" name="KH_HoTen" required placeholder="Nhập họ tên"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500">
                        </div>
                        <div class="form-group">
                            <label for="KH_SDT" class="block text-sm font-medium text-gray-700">Số Điện
                                Thoại</label>
                            <input type="tel" name="KH_SDT" required
                                placeholder="Nhập số điện thoại"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500">
                        </div>
                        <div class="form-group">
                            <label for="KH_Email" class="block text-sm font-medium text-gray-700">Email</label>
                            <input type="email" name="KH_Email" required placeholder="Nhập email"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500">
                        </div>
                        <div class="form-group">
                        ...
                        <input type="hidden" name="lkh_id" value="1">
                        <div>
                            <button type="submit"
                                class="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition">Đăng
                                Ký</button>
                        </div>
                    </form>
                </div>
